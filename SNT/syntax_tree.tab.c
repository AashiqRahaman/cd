...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* stmt: ID '=' expr ';'  */
#line 33 "syntax_tree.y"
                       {
          Node* assignNode = createNode("=", createNode((yyvsp[-3].str), NULL, NULL), (yyvsp[-1].node));
          printf("\nSyntax Tree:\n");
          printTree(assignNode, 0);
          free((yyvsp[-3].str));
      }
#line 1085 "syntax_tree.tab.c"
    break;
...
#line 1126 "syntax_tree.tab.c"
    break;


#line 1130 "syntax_tree.tab.c"
